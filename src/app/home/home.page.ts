...
export class HomePage {
  public pizza=[
    {cod:1,nome:'Pizza de frango' ,categoria:'pizza' ,descrição: 'A pizza de frango é uma opção deliciosa e saudável para quem prefere uma pizza com menos gordura e calorias. Esta pizza geralmente é feita com uma base de massa de pizza, que é coberta com molho de tomate, queijo mussarela e pedaços de frango cozido. ',valor:'R$32,00' ,},
    {cod:2 ,nome:'Pizza de calabresa' ,categoria:'pizza' ,descrição: 'A pizza de calabresa é um sabor clássico e muito popular em muitas partes do mundo. Esta pizza é normalmente feita com uma base de massa de pizza, que é coberta com molho de tomate, queijo mussarela e fatias finas de linguiça calabresa. A calabresa é um tipo de linguiça picante, que é bastante saborosa e dá um toque especial à pizza.' ,valor: 'R$30,00' ,},
